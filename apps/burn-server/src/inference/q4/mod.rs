...
/// CUDA backend — full 24 GB VRAM, no WDDM budget, native dispatch.
/// Standard reduction kernels (max_dim, sum_dim, mean_dim) work correctly.
/// Uses fusion wrapper (same as default `burn::backend::Cuda`).
#[cfg(feature = "cuda")]
