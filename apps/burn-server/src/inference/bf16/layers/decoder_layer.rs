...
/// Create a `burn::nn::Linear` from a weight tensor and optional bias.
///
/// Weight tensor shape: [out_features, in_features] (PyTorch convention).
fn linear_from_weights<B: Backend>(
    weight: Tensor<B, 2>,
